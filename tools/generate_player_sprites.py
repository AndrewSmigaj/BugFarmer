...
PALETTES = {
    ...
    'miner':    {'hair': ((210, 180, 90, 255), (170, 140, 60, 255)),    # yellow hardhat-ish cap
                 'shirt': ((90, 95, 105, 255), (60, 65, 75, 255)),       # grey work shirt
                 'pants': ((110, 95, 70, 255), (75, 62, 45, 255))},      # tan/brown work pants
}
