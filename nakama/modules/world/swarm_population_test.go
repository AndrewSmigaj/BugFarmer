...
// (Centipedes were "individual" swarm-of-1 and reproduced by minting a new swarm beside the
// parent; that path is retired — centipede packs are category:"swarm" and lay a visible brood
// like every other nestless species, so the mint-beside-parent test was removed with the code.)
